    ...
    if trigger_mchirp is not None:
        ...
        if not trigger_bins:
            ...
            for roq,roq_path in zip([os.path.basename(roq_path) for roq_path in roq_paths],roq_paths):
                ...
                print 'Tried: ({}*{}={})<={}<=({}*{}={})'.format(mc_priors[roq][0],roq_mass_freq_scale_factor,mc_priors[roq][0]*roq_mass_freq_scale_factor,trigger_mchirp,mc_priors[roq][1],roq_mass_freq_scale_factor,mc_priors[roq][1]*roq_mass_freq_scale_factor)
            sys.exit(1)
