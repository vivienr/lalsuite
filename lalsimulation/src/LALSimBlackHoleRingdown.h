...
INT4 XLALSimIMREOBGenerateQNMFreqV2(COMPLEX16Vector *modefreqs, const REAL8 mass1, const REAL8 mass2, const REAL8 spin1[3], const REAL8 spin2[3], UINT4 l, INT4 m, UINT4 nmodes, Approximant approximant, REAL8 reomegaqnm_a, REAL8 imomegaqnm_a, INT4 modeqnm_a, REAL8 reomegaqnm_b, REAL8 imomegaqnm_b, INT4 modeqnm_b);
INT4 XLALSimIMREOBGenerateQNMFreqV2fromFinal(COMPLEX16Vector *modefreqs, const REAL8 finalMass, const REAL8 finalSpin, UINT4 l, INT4 m, UINT4 nmodes, REAL8 reomegaqnm_a, REAL8 imomegaqnm_a, INT4 modeqnm_a, REAL8 reomegaqnm_b, REAL8 imomegaqnm_b, INT4 modeqnm_b);
